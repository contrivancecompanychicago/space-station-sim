...
import first from './namegen/firstname_set'
import last from './namegen/lastname_set'


export default function namegen():{firstname:string, lastname:string}{
  return {
    firstname: first[Math.floor(first.length*Math.random())],
    lastname: last[Math.floor(last.length*Math.random())],
  }
}
...
// // generator function
//
//   export default function generate_name (type) {
